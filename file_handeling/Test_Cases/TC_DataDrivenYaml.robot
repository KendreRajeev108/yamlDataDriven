...
Variables        ../Lib/Python/yamlDataDriver.yml
Variables        ../Lib/Python/dummyYamlSet.yml
...
Access yaml data in robot file
    [Documentation]       web Navigation' 
    ...                    \n\ is set to correct default value \n
    [Tags]    web
    Log many    ${newAdd.part01.part02.part03}    ${calling-birds}[1]
    Log to console    ${newAdd.part01.part02.part03}

    Log    ${newAdd.part01.part02.part03}
    Log to console    ${newAdd.part01.part02.part03}


    # Log many    
    Log to console    ${calling-birds}[3]

Data driven approach by yaml
    log many     ${calling-birds}[1]
